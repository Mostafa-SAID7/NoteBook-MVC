-- Initial Schema Migration for NoteBook
-- Created: June 2026
-- Version: 1.0.0

-- This script creates the initial database schema for NoteBook application.
-- It should be run on a fresh PostgreSQL database.
...
COMMENT ON TABLE application_users IS 'Stores user account information';
COMMENT ON TABLE notes IS 'Stores notes with soft delete support';
COMMENT ON TABLE tags IS 'Stores tags for note categorization';
